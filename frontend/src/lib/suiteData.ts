...
export const sourceSystems = [
  { name: 'AIB2BMarketplaceOperationsAssistant', ownership: 'Customers source capabilities and workflows', coverage: ['Customers', 'Orders', 'Catalog'] },
  { name: 'AIB2BMarketplaceOperationsOperations', ownership: 'Orders source capabilities and workflows', coverage: ['Inventory', 'Pricing', 'Promotions'] },
  { name: 'AIB2BMarketplaceOperationsAnalytics', ownership: 'Catalog source capabilities and workflows', coverage: ['Fulfillment', 'Returns', 'Exceptions'] },
  { name: 'AIB2BMarketplaceOperationsWorkflow', ownership: 'Inventory source capabilities and workflows', coverage: ['Reviews', 'Analytics', 'Reports'] },
];
