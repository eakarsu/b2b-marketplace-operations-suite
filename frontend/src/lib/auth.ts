export const AUTH_COOKIE = 'b2b_marketplace_operations_suite_session';
...
export const demoUsers: DemoUser[] = [
  {
    email: 'admin@b2b-marketplace-operations.local',
    password: 'admin123',
    firstName: 'Legal',
    lastName: 'Operator',
    role: 'admin',
  ...
  {
    email: 'manager@b2b-marketplace-operations.local',
    password: 'manager123',
    firstName: 'Legal',
    lastName: 'Manager',
    role: 'manager',
  ...
  {
    email: 'analyst@b2b-marketplace-operations.local',
    password: 'analyst123',
    firstName: 'Legal',
    lastName: 'Analyst',
    role: 'analyst',
