...
export default function DashboardPage() {
  return (
    <UnifiedShell
      ...
      title="B2B Marketplace Operations Dashboard"
      subtitle="One merged b2b marketplace operations view for Customers, Orders, Catalog, Inventory, Pricing, documents, audit, and AI."
    >
      ...
      <div className="grid columns-2">
        <div className="card stack">
          ...
          <div className="muted">
            This suite removes project-based navigation and groups shared b2b marketplace operations jobs into one surface. Customers, Orders, Catalog, Inventory, Pricing, Promotions, documents, audit, and AI are presented as platform features.</div>
