const baseUrl = process.env.SMOKE_BASE_URL || 'http://127.0.0.1:5390';
...
const adminCookie = await login('admin@b2b-marketplace-operations.local', 'admin123');
const managerCookie = await login('manager@b2b-marketplace-operations.local', 'manager123');
const analystCookie = await login('analyst@b2b-marketplace-operations.local', 'analyst123');
