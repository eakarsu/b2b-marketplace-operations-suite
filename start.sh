...
PORT="${PORT:-5390}"
DB_NAME="${PGDATABASE:-b2b_marketplace_operations_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      B2B Marketplace Operations Suite"
echo "======================================="
echo
...
echo "Starting b2b marketplace operations suite frontend on http://localhost:$PORT"
echo "Login: admin@b2b-marketplace-operations.local / admin123"
